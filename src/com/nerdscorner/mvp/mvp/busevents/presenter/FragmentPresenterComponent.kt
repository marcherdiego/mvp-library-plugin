...
class FragmentPresenterComponent(basePath: String, basePackage: String, screenName: String, shouldCreateWiring: Boolean) : MvpComponent(basePath, basePackage, screenName, PRESENTER_TEMPLATE, screenName + PRESENTER_JAVA, shouldCreateWiring) {

    override fun relativePath() = RELATIVE_PATH

    companion object {
        private const val PRESENTER_TEMPLATE = "$LANGUAGE_PLACEHOLDER/fragment_presenter_template"
