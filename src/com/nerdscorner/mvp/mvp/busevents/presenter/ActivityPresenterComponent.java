...
public class ActivityPresenterComponent extends MvpComponent {
    private static final String PRESENTER_TEMPLATE = LANGUAGE_PLACEHOLDER + "/activity_presenter_template";
    ...
    public ActivityPresenterComponent(String basePath, String basePackage, String screenName, boolean shouldCreateWiring) {
