...
class ActivityViewComponent(basePath: String, basePackage: String, screenName: String, shouldCreateWiring: Boolean) : MvpComponent(basePath, basePackage, screenName, VIEW_TEMPLATE, screenName + VIEW_JAVA, shouldCreateWiring) {
