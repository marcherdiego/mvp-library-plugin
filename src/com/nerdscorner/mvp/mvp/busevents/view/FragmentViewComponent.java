...
public class FragmentViewComponent extends MvpComponent {
    private static final String VIEW_TEMPLATE = LANGUAGE_PLACEHOLDER + "/fragment_view_template";
    ...
    public FragmentViewComponent(String basePath, String basePackage, String screenName, boolean shouldCreateWiring) {
